...
namespace mtm{
    namespace escaperoom{
        ...
        /**
         * checks if two companies are identical by value
         * @param a - the first company
         * @param b - the second company
         * @return - true if the companies are identical
         *           false if the companies are different
         */
